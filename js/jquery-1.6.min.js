...
(function(a, b) {
    ...
    f.support = function() {
        ...
        a.appendChild(h),
        i.reliableMarginRight = (parseInt(c.defaultView.getComputedStyle(h, null).marginRight, 10) || 0) === 0),
        k.innerHTML = "",
    ...
    f.ajaxPrefilter("json jsonp", function(b, c, d) {
        ...
        if (b.dataTypes[0] === "jsonp" || b.jsonp !== !1 && (cb.test(b.url) || e && cb.test(b.data))) {
            ...
            b.jsonp !== !1 && (j = j.replace(cb, l),
            b.url === j && (e && (k = k.replace(cb, l)),
    ...
    f.fn.extend({
        show: function(a, b, c) {
            ...
            for (var g = 0, h = this.length; g < h; g++)
                ...
                e === "" && f.css(d, "display") === "none" && f._data(d, "olddisplay", ct(d.nodeName)));
            for (g = 0; g < h; g++) {
                d = this[g];
                if (d.style) {
                    e = d.style.display;
        ...
        animate: function(a, b, c, d) {
            ...
            return this[e.queue === !1 ? "each" : "queue"](function() {
                ...
                for (i in a) {
                    ...
                    f.css(this, "display") === "inline" && f.css(this, "float") === "none" && (f.support.inlineBlockNeedsLayout ? (j = ct(this.nodeName),
                ...
                for (i in a)
                    k = new f.fx(this,b,i),
                    h = a[i],
                    ck.test(h) ? k[h === "toggle" ? d ? "show" : "hide" : h]() : (l = cl.exec(h),
                    m = k.cur(),
                    l ? (n = parseFloat(l[2]),
    ...
    : f.fn.offset = function(a) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
            ...
            b === d && (l += b.offsetTop,
            m += b.offsetLeft,
            f.offset.doesNotAddBorder && (!f.offset.doesAddBorderForTableAndCells || !cu.test(b.nodeName)) && (l += parseFloat(c.borderTopWidth) || 0,
